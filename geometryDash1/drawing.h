...
static const Color Orange = MakeColor(253, 215, 1);
static const Color LightBlue = MakeColor(85, 85, 170);
static const Color Azzurro = MakeColor(49, 247, 219);

//colori start
static const Color LightGreen = MakeColor(197, 247, 87);
...
static const Color SecondoAzzurro = MakeColor(20, 173, 165);
static const Color TerzoVerde = MakeColor(193, 247, 82);
static const Color SecondoVerde = MakeColor(196, 248, 81);
